...
if(isset($_POST['login'])){
         ...
         if(!empty($email) && !empty($password)){
              $select = mysqli_query($connection,"SELECT `id` FROM  `client` WHERE `email`='$email' AND `password`='$password' ");
              ...
              if(mysqli_num_rows($select)){
                  ...
                  echo "<script>alert('Something Went Wrong: Login detail not correct')</script>";
              }
                           ...
                           <div class="container pt-28 pb-40 xl:pt-36 lg:pt-36 md:pt-36 xl:pb-[12.5rem] lg:pb-[12.5rem] md:pb-[12.5rem] !text-center">
                                    <div class="flex flex-wrap mx-[-15px]">
                                             <div class="xl:w-8/12 lg:w-8/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto">
                                                      <h1 class="text-[calc(1.365rem_+_1.38vw)] font-bold leading-[1.2] xl:text-[2.4rem] !mb-3">Sign In</h1>
                                                      <nav class="inline-block" aria-label="breadcrumb">
                                                               <ol class="breadcrumb flex flex-wrap bg-[none] mb-4 p-0 !rounded-none list-none">
                                                                        ...
                                                                        <li class="breadcrumb-item active flex text-[#60697b] pl-2 before:font-normal before:flex before:items-center before:text-[rgba(96,105,123,0.35)] before:content-['\e931'] before:text-[0.9rem] before:-mt-px before:pr-2 before:font-Unicons" aria-current="page">Sign In</li>
                                                               </ol>
                                                      </nav>
                                                      <!-- /nav -->
                                             </div>
                                             ...
                                             <div class="lg:w-7/12 xl:w-6/12 xxl:w-5/12 w-full flex-[0_0_auto] px-[15px] max-w-full !mx-auto !mt-[-10rem]">
                                                      <div class="card">
                                                               <div class="card-body !p-12 !text-center">
                                                                        <h2 class="mb-3 text-left">Sign In to Paint Hub</h2>
                                                                       <p class="lead text-[0.9rem] font-medium !leading-[1.65] !mb-6 text-left"> Welcome to Enugu state painting hub</p>
                                                                        <form method="POST" class="text-left !mb-3">
                                                                                 ...
                                                                                 <button name="login" type="submit" class="btn btn-primary text-white !bg-[#3f78e0] border-[#3f78e0] hover:text-white hover:bg-[#3f78e0] hover:border-[#3f78e0] focus:shadow-[rgba(92,140,229,1)] active:text-white active:bg-[#3f78e0] active:border-[#3f78e0] disabled:text-white disabled:bg-[#3f78e0] disabled:border-[#3f78e0] !rounded-[50rem] btn-login w-full mb-2">Sign In</button>
                                                                        </form>
                                                                        <!-- /form -->
                                                                        <p class="!mb-0">Don't have an account? <a href="./register.php" class="hover">Sign in</a></p>
